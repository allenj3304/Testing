...
namespace MySharePointAppWeb
{
    public static class TokenHelper
    {
        ...
        private static X509Certificate2 GetCertificateFromStore()
        {
            ...
            {
                storedCert = (string.IsNullOrEmpty(ClientSigningCertificatePath) || string.IsNullOrEmpty(ClientSigningCertificatePassword))
                                 ? null
            ...
            try
            {
                ...
                // Find the cert
                storedCert =
                    store.Certificates.Find(X509FindType.FindBySerialNumber, ClientSigningCertificateSerialNumber, true)
